...
public class ContactListFragment extends EaseContactListFragment {
    ...
    private void showDialog(final int position) {
        new AlertDialog.Builder(getActivity()).setMessage("确定删除吗?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
                ...
                Modle.getInstance().getGlobalThread().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            //本地
                            Modle.getInstance().getHelperManager().getContactDAO().deleteContactByHxId(userInfo.getHxid());
                            //内存和页面
                            if(getActivity() != null) {
